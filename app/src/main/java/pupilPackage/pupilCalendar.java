...
import adapters.pupilCalendarAdapter;
import databaseClasses.Constants;
import databaseClasses.TimeScheduling;

public class pupilCalendar extends Fragment {
  ...
  //  private DatabaseReference mDatabase;
    ...
    public static HashMap<String,ArrayList<TimeScheduling>> timesToDaysScheduling;
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.pupil_calendar, container, false);
      //  mDatabase = FirebaseDatabase.getInstance().getReference();
        ...
        pupilName=pupilPagesNavigator.fullName;
        ...
        continueCal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Calendar thisWeak=Calendar.getInstance();
                thisWeak.set(Calendar.DAY_OF_WEEK,Calendar.SATURDAY);
                thisWeak.set(Calendar.HOUR,23);
                thisWeak.set(Calendar.MINUTE,59);
                thisWeak.set(Calendar.SECOND,59);
                currentDateScheduling = new Date(currentDateScheduling.getTime() + 7 * 24 * 3600 * 1000);
                Calendar nextWeek=Calendar.getInstance();
                nextWeek.setTime(currentDateScheduling);

                if(nextWeek.after(thisWeak)){
                    currentDateScheduling = new Date(currentDateScheduling.getTime() - 7 * 24 * 3600 * 1000);
                    return;
                }
                setListFromFirebase();
    ...
    public void setClickListenerForTexts() {
        day1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pupilCalendarAdapter recyclerAdapter = new pupilCalendarAdapter(getContext(),timesToDaysScheduling.get(Constants.sunday) ,schoolId,
                        teacherId,pupilId,pupilName,Constants.sunday) ;
        ...
        day2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                currentDateScheduling.setDate(day);
                pupilCalendarAdapter recyclerAdapter = new pupilCalendarAdapter(getContext(),timesToDaysScheduling.get(Constants.monday) ,schoolId,
                        teacherId,pupilId,pupilName,Constants.monday) ;
                mRecyclerView.setAdapter(recyclerAdapter);
            }
        });
        day3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                currentDateScheduling.setDate(day);
                pupilCalendarAdapter recyclerAdapter = new pupilCalendarAdapter(getContext(),timesToDaysScheduling.get(Constants.tuesday),schoolId,teacherId,
                        pupilId,pupilName,Constants.tuesday) ;
                mRecyclerView.setAdapter(recyclerAdapter);
            }
        });
        day4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                currentDateScheduling.setDate(day);
                pupilCalendarAdapter recyclerAdapter = new pupilCalendarAdapter(getContext(),timesToDaysScheduling.get(Constants.wensday),schoolId,teacherId,
                        pupilId,pupilName,Constants.wensday) ;
                mRecyclerView.setAdapter(recyclerAdapter);
            }
        });
        day5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                currentDateScheduling.setDate(day);
                pupilCalendarAdapter recyclerAdapter = new pupilCalendarAdapter(getContext(),timesToDaysScheduling.get(Constants.thursday) ,schoolId,teacherId,
                        pupilId,pupilName,Constants.thursday) ;
                mRecyclerView.setAdapter(recyclerAdapter);
            }
        });
        day6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                currentDateScheduling.setDate(day);
                pupilCalendarAdapter recyclerAdapter = new pupilCalendarAdapter(getContext(), timesToDaysScheduling.get(Constants.friday),schoolId,teacherId,
                        pupilId,pupilName,Constants.friday) ;
                mRecyclerView.setAdapter(recyclerAdapter);
            }
        });
        day7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                currentDateScheduling.setDate(day);
                pupilCalendarAdapter recyclerAdapter = new pupilCalendarAdapter(getContext(),timesToDaysScheduling.get(Constants.saturday) ,schoolId,teacherId,pupilId,
                        pupilName,Constants.saturday) ;
                mRecyclerView.setAdapter(recyclerAdapter);
            }
        });
    }
